      ...
      <footer className="text-center bg-gray-900 text-white">
            ...
            <form action>
              <div className="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
                <div className="md:ml-auto md:mb-6">
                  <p className>
                    <strong>Đăng ký nhận thông tin ưu đãi</strong>
                  </p>
                </div>
        ...
        "
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2">
            <div className="mb-6">
              <h5 className="uppercase text-white mb-2.5 text-left">Giới thiệu</h5>
              <ul className="list-none mb-0 text-left">
                ...
                <li className="mt-1" >
                  <a href="#!" className="text-white">
                    Nhờ có host, mọi điều đều có thế
                  </a>
                </li>
                ...
                <li className="mt-1" >
                  <a href="#!" className="text-white">
                   Thư của nhà sáng tạo
                  </a>
                </li>
              </ul>
            </div>
            <div className="mb-6 text-left">
              <h5 className="uppercase text-white mb-2.5 ">Cộng Đồng</h5>
            ...
            <div className="mb-6 text-left">
              <h5 className="uppercase  text-white  mb-2.5">Đón tiếp khách</h5>
              <ul className="list-none mb-0">
                <li className="mt-1">
                  <a href="#!" className="text-white">
                   Cho thuê nhà 
            ...
            <div className="mb-6 text-left">
              <h5 className="uppercase text-white mb-2.5">Hỗ Trợ</h5>
              <ul className="list-none mb-0">
                <li className="mt-1">
                  <a href="" className="text-white">
